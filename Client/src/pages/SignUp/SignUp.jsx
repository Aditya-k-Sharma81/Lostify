    ...
    return (
        <div className="flex min-h-screen flex-col font-sans">
            <div className="flex flex-1 flex-col lg:flex-row overflow-hidden">
                ...
                <div className="flex w-full items-center justify-center bg-white p-8 lg:w-[40%]">
                    ...
                    >
                        <div className="mb-8 text-center">
                            <h2 className="text-3xl font-black tracking-tighter text-black lg:text-4xl">Sign Up</h2>
                            <p className="mt-2 text-sm font-medium text-gray-500">Create your account</p>
                        </div>

                        <div className="space-y-5">
                            <div className="group">
                                <label className="block mb-1.5 text-xs font-bold uppercase tracking-wider text-gray-700 ml-1">Full Name</label>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                            <p className="text-sm font-medium text-gray-500">
                                ...
                                <Link to="/login" className="ml-2 font-bold text-black hover:underline underline-offset-4 decoration-2 transition-all">
                                    Login
                                </Link>
                            </p>
                        </div>
                ...
                {/* Hero Side */}
                <div className="relative flex min-h-[500px] w-full items-center justify-center overflow-hidden bg-gradient-to-br from-[#ffe3ed] via-[#fdfdeb] to-[#f8f4c2] p-6 lg:w-[60%] lg:min-h-[540px]">
                    ...
                    <div className="relative group max-w-[824px] transform transition-all duration-1000">
                        ...
                        <div className="absolute top-1/2 left-1/2 w-[92%] -translate-x-1/2 -translate-y-1/2 rounded-3xl bg-white/90 p-8 text-center backdrop-blur-md border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.15)] lg:w-[80%] lg:p-12 animate-fade-in-up transition-all duration-500 group-hover:bg-white">
                            <h2 className="mb-6 text-3xl font-black tracking-tight text-gray-900 lg:text-5xl">
